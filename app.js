...
function project1Redirect() {
  let repoUrl = "https://github.com/Jamal-Karim/Weather-App";

  window.open(repoUrl, "_blank");
}

function project1RedirectLive() {
  let liveUrl = "https://jamal-karim.github.io/Weather-App/";
